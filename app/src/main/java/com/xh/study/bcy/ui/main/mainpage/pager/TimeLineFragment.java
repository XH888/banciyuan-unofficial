...
import com.xh.study.bcy.adapter.binder.ext.TimelineHeaderViewBinder;
...
public class TimeLineFragment extends BaseLoadingFragment<BaseLoadingMvp.View, TimeLinePresenter> implements BaseLoadingMvp.View {
    ...
    private void initRecyclerView() {
        ...
        adapter.register(HeaderModel.class, new TimelineHeaderViewBinder());
