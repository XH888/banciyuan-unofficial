...
import com.xh.study.bcy.adapter.binder.GroupItemViewBinder;
...
public class GroupCommonFragment extends BaseLoadingFragment<BaseLoadingMvp.View, GroupCommonPresenter> implements  BaseLoadingMvp.View {
    ...
    public static GroupCommonFragment newInstance() {
    ...
    private void initRecyclerView() {
        ...
        adapter.register(HotGroupBean.class,new GroupItemViewBinder(getContext()));
    ...
    @NonNull
    @Override
    public GroupCommonPresenter providePresenter() {
        return new GroupCommonPresenter();
    }
}
