...
public class TagHotFragment extends BaseLoadingFragment<BaseLoadingMvp.View,TagHotPresenter> implements BaseLoadingMvp.View {
    @BindView(R.id.swipe)
    ...
    public static TagHotFragment newInstance() {
    ...
    @NonNull
    @Override
    public TagHotPresenter providePresenter() {
        return new TagHotPresenter();
    }
}
