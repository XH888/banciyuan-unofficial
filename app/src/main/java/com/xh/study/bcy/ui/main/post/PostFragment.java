package com.xh.study.bcy.ui.main.post;
...
public class PostFragment extends BaseFragment<MainPageMvp.View, MainPagePresenter> implements MainPageMvp.View {
    ...
    protected void onFragmentCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        mViewPager.setAdapter(new FragmentStatePagerAdapter(getChildFragmentManager()) {
            ...
            final String titles[] = {
                    PostFragment.this.getString(R.string.focus),
                    PostFragment.this.getString(R.string.index_unit),
                    PostFragment.this.getString(R.string.circle)
            };
