package com.xh.study.bcy.widget.tablayout;
    ...
    public XTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mTabTextSize = a.getDimensionPixelSize (
                    R.styleable.XTabLayout_x_tabSize, ta.getDimensionPixelSize(android.support.v7.appcompat.R.styleable.TextAppearance_android_textSize,0));
